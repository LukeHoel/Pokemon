...
namespace olc {
void GFX2D::DrawSprite(olc::Sprite *sprite,
...
void olc::GFX2D::Transform2D::Multiply() {
  for (int c = 0; c < 3; c++) {
    for (int r = 0; r < 3; r++) {
      matrix[nTargetMatrix][c][r] =
          matrix[2][0][r] * matrix[nSourceMatrix][c][0] +
...
void olc::GFX2D::Transform2D::Forward(float in_x, float in_y, float &out_x,
                                      float &out_y) {
  out_x = in_x * matrix[nSourceMatrix][0][0] +
          in_y * matrix[nSourceMatrix][1][0] + matrix[nSourceMatrix][2][0];
  out_y = in_x * matrix[nSourceMatrix][0][1] +
          in_y * matrix[nSourceMatrix][1][1] + matrix[nSourceMatrix][2][1];
  float out_z = in_x * matrix[nSourceMatrix][0][2] +
                in_y * matrix[nSourceMatrix][1][2] +
...
void olc::GFX2D::Transform2D::Backward(float in_x, float in_y, float &out_x,
                                       float &out_y) {
  out_x = in_x * matrix[3][0][0] + in_y * matrix[3][1][0] + matrix[3][2][0];
  out_y = in_x * matrix[3][0][1] + in_y * matrix[3][1][1] + matrix[3][2][1];
  float out_z =
      in_x * matrix[3][0][2] + in_y * matrix[3][1][2] + matrix[3][2][2];
  if (out_z != 0) {
    out_x /= out_z;
    out_y /= out_z;
  }
...
void olc::GFX2D::Transform2D::Invert() {
  if (bDirty) // Obviously costly so only do if needed
  {
    ...
    matrix[3][0][0] =
        ...
        idet;
    matrix[3][1][0] =
        (matrix[nSourceMatrix][2][0] * matrix[nSourceMatrix][1][2] -
         matrix[nSourceMatrix][1][0] * matrix[nSourceMatrix][2][2]) *
        idet;
    matrix[3][2][0] =
        (matrix[nSourceMatrix][1][0] * matrix[nSourceMatrix][2][1] -
    ...
    matrix[3][0][1] =
        ...
        idet;
    matrix[3][1][1] =
        (matrix[nSourceMatrix][0][0] * matrix[nSourceMatrix][2][2] -
         matrix[nSourceMatrix][2][0] * matrix[nSourceMatrix][0][2]) *
        idet;
    matrix[3][2][1] =
        (matrix[nSourceMatrix][0][1] * matrix[nSourceMatrix][2][0] -
    ...
    matrix[3][0][2] =
        ...
        idet;
    matrix[3][1][2] =
        (matrix[nSourceMatrix][0][2] * matrix[nSourceMatrix][1][0] -
         matrix[nSourceMatrix][0][0] * matrix[nSourceMatrix][1][2]) *
        idet;
    matrix[3][2][2] =
        (matrix[nSourceMatrix][0][0] * matrix[nSourceMatrix][1][1] -
